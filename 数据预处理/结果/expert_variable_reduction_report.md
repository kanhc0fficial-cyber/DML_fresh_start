...
| Cat-2: 电能计量表 | 13 |
| Cat-3: 控制限/报警信号 | 2 |
| Cat-4: 浮选机单机电流/电压（Group C） | 14 |
| Cat-5: 离心鼓风机电流/频率/进口温度（Group C） | 9 |
| Cat-6: 浓缩机/磁选机机械监测 | 4 |
| Cat-7: 渣浆泵次要电流信号（Group C） | 18 |
| Cat-8: 与 Group A 代表信号重复的同名泵信号 | 5 |
| **合计** | **100** |
...
共 **29** 个聚合概念，178 个代表变量参与聚合，全部使用 **mean** 方法。
...
| `FX_AH10_AI6` | 浮选3#低压室2#变压器总瞬时有功功率 | drop | `(deleted)` | [Cat-2: 电能计量表] 专家知识文档各段观测空间均不包含变压器/变频器电能指标（有功功率/无功功率/功率因素/电网频率）。这些量反映电力消耗，对矿产品品位无直接解释力，删除以减少 DML 模型噪声。 |
| `FX_AH12_AI6` | 浮选4#鼓风机变频总瞬时有功功率 | drop | `(deleted)` | [Cat-2: 电能计量表] 专家知识文档各段观测空间均不包含变压器/变频器电能指标（有功功率/无功功率/功率因素/电网频率）。这些量反映电力消耗，对矿产品品位无直接解释力，删除以减少 DML 模型噪声。 |
| `FX_AH14_AI7` | 浮选5#鼓风机变频总瞬时无功功率 | drop | `(deleted)` | [Cat-2: 电能计量表] 专家知识文档各段观测空间均不包含变压器/变频器电能指标（有功功率/无功功率/功率因素/电网频率）。这些量反映电力消耗，对矿产品品位无直接解释力，删除以减少 DML 模型噪声。 |
| `FX_AH16_AI5` | 浮选6#鼓风机变频总功率因素 | drop | `(deleted)` | [Cat-2: 电能计量表] 专家知识文档各段观测空间均不包含变压器/变频器电能指标（有功功率/无功功率/功率因素/电网频率）。这些量反映电力消耗，对矿产品品位无直接解释力，删除以减少 DML 模型噪声。 |
| `FX_AH16_AI6` | 浮选6#鼓风机变频总瞬时有功功率 | drop | `(deleted)` | [Cat-2: 电能计量表] 专家知识文档各段观测空间均不包含变压器/变频器电能指标（有功功率/无功功率/功率因素/电网频率）。这些量反映电力消耗，对矿产品品位无直接解释力，删除以减少 DML 模型噪声。 |
...
| `FX_AH7_AI6` | 浮选2#低压室1#变压器总瞬时有功功率 | drop | `(deleted)` | [Cat-2: 电能计量表] 专家知识文档各段观测空间均不包含变压器/变频器电能指标（有功功率/无功功率/功率因素/电网频率）。这些量反映电力消耗，对矿产品品位无直接解释力，删除以减少 DML 模型噪声。 |
| `FX_AH9_AI6` | 浮选3#低压室1#变压器总瞬时有功功率 | drop | `(deleted)` | [Cat-2: 电能计量表] 专家知识文档各段观测空间均不包含变压器/变频器电能指标（有功功率/无功功率/功率因素/电网频率）。这些量反映电力消耗，对矿产品品位无直接解释力，删除以减少 DML 模型噪声。 |
...
| `FX_FT_612C` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FT_612D` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FT_612E` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FT_612F` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FT_612G` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FT_612H` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FT_622A` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FT_622A_LJ` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FT_622B` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FT_622C` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FT_622D` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FT_622E` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FT_622E_SP` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FT_622F` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FT_622G` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FT_622H` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FT_642A` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FT_642B` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FT_642C` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FT_642D` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_FXJ401_I` | 浮选机(粗选)401电流 | drop | `(deleted)` | [Cat-4: 浮选机单机电流/电压（Group C）] 专家知识文档浮选段观测空间不包含浮选机电机电流/电压。电流仅反映电机负载状态（有无堵转），对浮选分离效率无直接解释力。气量（_AI5/AI9）和阀位（_AI7）已保留为主控变量。 |
| `FX_FXJ401_U` | 浮选机(粗选)401电压 | drop | `(deleted)` | [Cat-4: 浮选机单机电流/电压（Group C）] 专家知识文档浮选段观测空间不包含浮选机电机电流/电压。电流仅反映电机负载状态（有无堵转），对浮选分离效率无直接解释力。气量（_AI5/AI9）和阀位（_AI7）已保留为主控变量。 |
| `FX_FXJ402_I` | 浮选机(粗选)402电流 | drop | `(deleted)` | [Cat-4: 浮选机单机电流/电压（Group C）] 专家知识文档浮选段观测空间不包含浮选机电机电流/电压。电流仅反映电机负载状态（有无堵转），对浮选分离效率无直接解释力。气量（_AI5/AI9）和阀位（_AI7）已保留为主控变量。 |
| `FX_FXJ407_I` | 浮选机(粗选)407电流 | drop | `(deleted)` | [Cat-4: 浮选机单机电流/电压（Group C）] 专家知识文档浮选段观测空间不包含浮选机电机电流/电压。电流仅反映电机负载状态（有无堵转），对浮选分离效率无直接解释力。气量（_AI5/AI9）和阀位（_AI7）已保留为主控变量。 |
| `FX_FXJ410_I` | 浮选机(粗选)410电流 | drop | `(deleted)` | [Cat-4: 浮选机单机电流/电压（Group C）] 专家知识文档浮选段观测空间不包含浮选机电机电流/电压。电流仅反映电机负载状态（有无堵转），对浮选分离效率无直接解释力。气量（_AI5/AI9）和阀位（_AI7）已保留为主控变量。 |
| `FX_FXJ504_I` | 浮选机(精选)504电流 | drop | `(deleted)` | [Cat-4: 浮选机单机电流/电压（Group C）] 专家知识文档浮选段观测空间不包含浮选机电机电流/电压。电流仅反映电机负载状态（有无堵转），对浮选分离效率无直接解释力。气量（_AI5/AI9）和阀位（_AI7）已保留为主控变量。 |
| `FX_FXJ601_I` | 浮选机(扫选一)601电流 | drop | `(deleted)` | [Cat-4: 浮选机单机电流/电压（Group C）] 专家知识文档浮选段观测空间不包含浮选机电机电流/电压。电流仅反映电机负载状态（有无堵转），对浮选分离效率无直接解释力。气量（_AI5/AI9）和阀位（_AI7）已保留为主控变量。 |
| `FX_FXJ602_I` | 浮选机(扫选一)602电流 | drop | `(deleted)` | [Cat-4: 浮选机单机电流/电压（Group C）] 专家知识文档浮选段观测空间不包含浮选机电机电流/电压。电流仅反映电机负载状态（有无堵转），对浮选分离效率无直接解释力。气量（_AI5/AI9）和阀位（_AI7）已保留为主控变量。 |
| `FX_FXJ603_I` | 浮选机(扫选一)603电流 | drop | `(deleted)` | [Cat-4: 浮选机单机电流/电压（Group C）] 专家知识文档浮选段观测空间不包含浮选机电机电流/电压。电流仅反映电机负载状态（有无堵转），对浮选分离效率无直接解释力。气量（_AI5/AI9）和阀位（_AI7）已保留为主控变量。 |
| `FX_FXJ604_I` | 浮选机(扫选一)604电流 | drop | `(deleted)` | [Cat-4: 浮选机单机电流/电压（Group C）] 专家知识文档浮选段观测空间不包含浮选机电机电流/电压。电流仅反映电机负载状态（有无堵转），对浮选分离效率无直接解释力。气量（_AI5/AI9）和阀位（_AI7）已保留为主控变量。 |
| `FX_FXJ605_I` | 浮选机(扫选一)605电流 | drop | `(deleted)` | [Cat-4: 浮选机单机电流/电压（Group C）] 专家知识文档浮选段观测空间不包含浮选机电机电流/电压。电流仅反映电机负载状态（有无堵转），对浮选分离效率无直接解释力。气量（_AI5/AI9）和阀位（_AI7）已保留为主控变量。 |
| `FX_FXJ701_I` | 浮选机(扫选二)701电流 | drop | `(deleted)` | [Cat-4: 浮选机单机电流/电压（Group C）] 专家知识文档浮选段观测空间不包含浮选机电机电流/电压。电流仅反映电机负载状态（有无堵转），对浮选分离效率无直接解释力。气量（_AI5/AI9）和阀位（_AI7）已保留为主控变量。 |
| `FX_FXJ801_I` | 浮选机(扫选三)801电流 | drop | `(deleted)` | [Cat-4: 浮选机单机电流/电压（Group C）] 专家知识文档浮选段观测空间不包含浮选机电机电流/电压。电流仅反映电机负载状态（有无堵转），对浮选分离效率无直接解释力。气量（_AI5/AI9）和阀位（_AI7）已保留为主控变量。 |
| `FX_FXJ802_I` | 浮选机(扫选三)802电流 | drop | `(deleted)` | [Cat-4: 浮选机单机电流/电压（Group C）] 专家知识文档浮选段观测空间不包含浮选机电机电流/电压。电流仅反映电机负载状态（有无堵转），对浮选分离效率无直接解释力。气量（_AI5/AI9）和阀位（_AI7）已保留为主控变量。 |
| `FX_FXJ803_I` | 浮选机(扫选三)803电流 | keep_individual | `FX_FXJ803_I` | 该变量没有并联同类信号，按专家知识保留为独立特征。 |
| `FX_GFJ901_I` | 离心鼓风机901电流反馈 | drop | `(deleted)` | [Cat-5: 离心鼓风机电流/频率/进口温度（Group C）] 鼓风机充气量已由浮选槽气量实测值（FX_X*_AI5/AI9）捕获；电流/频率/进口温度是机械健康监测，不在专家浮选控制观测空间中。保留鼓风机出口压力（FX_PT_901_CK, FX_PT_902_CK）作为气网边界条件。 |
| `FX_GFJ902_F` | 离心鼓风机902频率反馈 | drop | `(deleted)` | [Cat-5: 离心鼓风机电流/频率/进口温度（Group C）] 鼓风机充气量已由浮选槽气量实测值（FX_X*_AI5/AI9）捕获；电流/频率/进口温度是机械健康监测，不在专家浮选控制观测空间中。保留鼓风机出口压力（FX_PT_901_CK, FX_PT_902_CK）作为气网边界条件。 |
| `FX_GFJ903_I` | 离心鼓风机903电流反馈 | drop | `(deleted)` | [Cat-5: 离心鼓风机电流/频率/进口温度（Group C）] 鼓风机充气量已由浮选槽气量实测值（FX_X*_AI5/AI9）捕获；电流/频率/进口温度是机械健康监测，不在专家浮选控制观测空间中。保留鼓风机出口压力（FX_PT_901_CK, FX_PT_902_CK）作为气网边界条件。 |
| `FX_GFJ904_I` | 离心鼓风机904电流反馈 | drop | `(deleted)` | [Cat-5: 离心鼓风机电流/频率/进口温度（Group C）] 鼓风机充气量已由浮选槽气量实测值（FX_X*_AI5/AI9）捕获；电流/频率/进口温度是机械健康监测，不在专家浮选控制观测空间中。保留鼓风机出口压力（FX_PT_901_CK, FX_PT_902_CK）作为气网边界条件。 |
| `FX_GFJ905_I` | 离心鼓风机905电流反馈 | drop | `(deleted)` | [Cat-5: 离心鼓风机电流/频率/进口温度（Group C）] 鼓风机充气量已由浮选槽气量实测值（FX_X*_AI5/AI9）捕获；电流/频率/进口温度是机械健康监测，不在专家浮选控制观测空间中。保留鼓风机出口压力（FX_PT_901_CK, FX_PT_902_CK）作为气网边界条件。 |
| `FX_GFJ906_F` | 离心鼓风机906频率反馈 | drop | `(deleted)` | [Cat-5: 离心鼓风机电流/频率/进口温度（Group C）] 鼓风机充气量已由浮选槽气量实测值（FX_X*_AI5/AI9）捕获；电流/频率/进口温度是机械健康监测，不在专家浮选控制观测空间中。保留鼓风机出口压力（FX_PT_901_CK, FX_PT_902_CK）作为气网边界条件。 |
...
| `FX_HV_621A_AI` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_HV_621B_AI` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_HV_621C_AI` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_HV_621D_AI` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
...
| `FX_LT_1601_HSV` | 一系列粗选给矿泵池液位液位控制上限 | drop | `(deleted)` | [Cat-3: 控制限/报警信号] 报警信号（_BJ）和控制上限（_HSV）是实测值的阈值派生量，非独立工艺状态，会在 DML 残差中引入人工非线性。 |
| `FX_LT_1602` | 一系列粗选泡沫及二扫底流泵池(给一扫)液位 | keep_individual | `FX_LT_1602` | 该变量没有并联同类信号，按专家知识保留为独立特征。 |
| `FX_LT_1602_BJ` | 一系列粗选泡沫及二扫底流泵池(给一扫)液位报警 | drop | `(deleted)` | [Cat-3: 控制限/报警信号] 报警信号（_BJ）和控制上限（_HSV）是实测值的阈值派生量，非独立工艺状态，会在 DML 残差中引入人工非线性。 |
...
| `FX_LT_621B` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_LT_621C` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_LT_621D` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_LT_641A` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_P1_N2_I` | 4#Φ30m浮选前浓缩机N2电流 | drop | `(deleted)` | [Cat-6: 浓缩机/磁选机机械监测] 提耙压力、落耙压力、挂泥电机扭矩为设备健康监测量，专家知识文档未将其列入磁选/浓缩段的观测或控制空间，对矿石品位无直接影响。 |
...
| `FX_TT_621B2` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_TT_621C1` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_TT_631B` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_TT_901_JK` | 离心鼓风机901进口温度 | drop | `(deleted)` | [Cat-5: 离心鼓风机电流/频率/进口温度（Group C）] 鼓风机充气量已由浮选槽气量实测值（FX_X*_AI5/AI9）捕获；电流/频率/进口温度是机械健康监测，不在专家浮选控制观测空间中。保留鼓风机出口压力（FX_PT_901_CK, FX_PT_902_CK）作为气网边界条件。 |
| `FX_TT_902_JK` | 离心鼓风机902进口温度 | drop | `(deleted)` | [Cat-5: 离心鼓风机电流/频率/进口温度（Group C）] 鼓风机充气量已由浮选槽气量实测值（FX_X*_AI5/AI9）捕获；电流/频率/进口温度是机械健康监测，不在专家浮选控制观测空间中。保留鼓风机出口压力（FX_PT_901_CK, FX_PT_902_CK）作为气网边界条件。 |
| `FX_TT_906_JK` | 离心鼓风机906进口温度 | drop | `(deleted)` | [Cat-5: 离心鼓风机电流/频率/进口温度（Group C）] 鼓风机充气量已由浮选槽气量实测值（FX_X*_AI5/AI9）捕获；电流/频率/进口温度是机械健康监测，不在专家浮选控制观测空间中。保留鼓风机出口压力（FX_PT_901_CK, FX_PT_902_CK）作为气网边界条件。 |
...
| `FX_TV_621A_AI` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_TV_621B_AI` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_TV_621C_AI` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
| `FX_TV_621D_AI` |  | drop | `(deleted)` | [Cat-1: 身份未知变量] 在全部元数据源中均无 COMMENT/描述，无法确定物理含义，不纳入 DML 模型。 |
...
| `FX_ZJB1203_I` | 渣浆泵(一扫给矿泵)1203电流反馈 | drop | `(deleted)` | [Cat-8: 与 Group A 代表信号重复的同名泵信号] 同功能泵已保留 Group A 代表信号（1201_F+I、1303_F+I），1203_I/1204_F/1204_I（一扫）和 1301_I/1302_I（二扫）为冗余重复，删除。 |
| `FX_ZJB1204_F` | 渣浆泵(一扫给矿泵)1204频率反馈 | drop | `(deleted)` | [Cat-8: 与 Group A 代表信号重复的同名泵信号] 同功能泵已保留 Group A 代表信号（1201_F+I、1303_F+I），1203_I/1204_F/1204_I（一扫）和 1301_I/1302_I（二扫）为冗余重复，删除。 |
| `FX_ZJB1204_I` | 渣浆泵(一扫给矿泵)1204电流反馈 | drop | `(deleted)` | [Cat-8: 与 Group A 代表信号重复的同名泵信号] 同功能泵已保留 Group A 代表信号（1201_F+I、1303_F+I），1203_I/1204_F/1204_I（一扫）和 1301_I/1302_I（二扫）为冗余重复，删除。 |
| `FX_ZJB1301_I` | 渣浆泵(二扫给矿泵)1301电流反馈 | drop | `(deleted)` | [Cat-8: 与 Group A 代表信号重复的同名泵信号] 同功能泵已保留 Group A 代表信号（1201_F+I、1303_F+I），1203_I/1204_F/1204_I（一扫）和 1301_I/1302_I（二扫）为冗余重复，删除。 |
| `FX_ZJB1302_I` | 渣浆泵(二扫给矿泵)1302电流反馈 | drop | `(deleted)` | [Cat-8: 与 Group A 代表信号重复的同名泵信号] 同功能泵已保留 Group A 代表信号（1201_F+I、1303_F+I），1203_I/1204_F/1204_I（一扫）和 1301_I/1302_I（二扫）为冗余重复，删除。 |
...
| `FX_ZJB1401_I` | 渣浆泵(精矿泵)1401电流反馈 | drop | `(deleted)` | [Cat-7: 渣浆泵次要电流信号（Group C）] 尾矿泵/精矿泵保留代表性频率反馈（控制量代理），删除冗余电流；事故泵属应急设备（正常生产不运行）；无名渣浆泵（33/34/41/43）无可追溯业务含义，均删除。 |
| `FX_ZJB1402_I` | 渣浆泵(精矿泵)1402电流反馈 | drop | `(deleted)` | [Cat-7: 渣浆泵次要电流信号（Group C）] 尾矿泵/精矿泵保留代表性频率反馈（控制量代理），删除冗余电流；事故泵属应急设备（正常生产不运行）；无名渣浆泵（33/34/41/43）无可追溯业务含义，均删除。 |
| `FX_ZJB1404_F` | 渣浆泵(精矿泵)1404频率反馈 | drop | `(deleted)` | [Cat-7: 渣浆泵次要电流信号（Group C）] 尾矿泵/精矿泵保留代表性频率反馈（控制量代理），删除冗余电流；事故泵属应急设备（正常生产不运行）；无名渣浆泵（33/34/41/43）无可追溯业务含义，均删除。 |
| `FX_ZJB1404_I` | 渣浆泵(精矿泵)1404电流反馈 | drop | `(deleted)` | [Cat-7: 渣浆泵次要电流信号（Group C）] 尾矿泵/精矿泵保留代表性频率反馈（控制量代理），删除冗余电流；事故泵属应急设备（正常生产不运行）；无名渣浆泵（33/34/41/43）无可追溯业务含义，均删除。 |
| `FX_ZJB14_I` | 渣浆泵14电流反馈 | keep_individual | `FX_ZJB14_I` | 该变量没有并联同类信号，按专家知识保留为独立特征。 |
| `FX_ZJB1502_F` | 渣浆泵(事故泵)1502频率反馈 | drop | `(deleted)` | [Cat-7: 渣浆泵次要电流信号（Group C）] 尾矿泵/精矿泵保留代表性频率反馈（控制量代理），删除冗余电流；事故泵属应急设备（正常生产不运行）；无名渣浆泵（33/34/41/43）无可追溯业务含义，均删除。 |
| `FX_ZJB1502_I` | 渣浆泵(事故泵)1502电流反馈 | drop | `(deleted)` | [Cat-7: 渣浆泵次要电流信号（Group C）] 尾矿泵/精矿泵保留代表性频率反馈（控制量代理），删除冗余电流；事故泵属应急设备（正常生产不运行）；无名渣浆泵（33/34/41/43）无可追溯业务含义，均删除。 |
| `FX_ZJB1504_F` | 渣浆泵(事故泵)1504频率反馈 | drop | `(deleted)` | [Cat-7: 渣浆泵次要电流信号（Group C）] 尾矿泵/精矿泵保留代表性频率反馈（控制量代理），删除冗余电流；事故泵属应急设备（正常生产不运行）；无名渣浆泵（33/34/41/43）无可追溯业务含义，均删除。 |
| `FX_ZJB1504_I` | 渣浆泵(事故泵)1504电流反馈 | drop | `(deleted)` | [Cat-7: 渣浆泵次要电流信号（Group C）] 尾矿泵/精矿泵保留代表性频率反馈（控制量代理），删除冗余电流；事故泵属应急设备（正常生产不运行）；无名渣浆泵（33/34/41/43）无可追溯业务含义，均删除。 |
| `FX_ZJB1601_F` | 渣浆泵(尾矿泵)1601频率反馈 | keep_individual | `FX_ZJB1601_F` | 该变量没有并联同类信号，按专家知识保留为独立特征。 |
| `FX_ZJB1601_I` | 渣浆泵(尾矿泵)1601电流反馈 | drop | `(deleted)` | [Cat-7: 渣浆泵次要电流信号（Group C）] 尾矿泵/精矿泵保留代表性频率反馈（控制量代理），删除冗余电流；事故泵属应急设备（正常生产不运行）；无名渣浆泵（33/34/41/43）无可追溯业务含义，均删除。 |
| `FX_ZJB1602_I` | 渣浆泵(尾矿泵)1602电流反馈 | drop | `(deleted)` | [Cat-7: 渣浆泵次要电流信号（Group C）] 尾矿泵/精矿泵保留代表性频率反馈（控制量代理），删除冗余电流；事故泵属应急设备（正常生产不运行）；无名渣浆泵（33/34/41/43）无可追溯业务含义，均删除。 |
| `FX_ZJB1603_I` | 渣浆泵(尾矿泵)1603电流反馈 | drop | `(deleted)` | [Cat-7: 渣浆泵次要电流信号（Group C）] 尾矿泵/精矿泵保留代表性频率反馈（控制量代理），删除冗余电流；事故泵属应急设备（正常生产不运行）；无名渣浆泵（33/34/41/43）无可追溯业务含义，均删除。 |
| `FX_ZJB1604_I` | 渣浆泵(尾矿泵)1604电流反馈 | drop | `(deleted)` | [Cat-7: 渣浆泵次要电流信号（Group C）] 尾矿泵/精矿泵保留代表性频率反馈（控制量代理），删除冗余电流；事故泵属应急设备（正常生产不运行）；无名渣浆泵（33/34/41/43）无可追溯业务含义，均删除。 |
| `FX_ZJB3002_I` | 渣浆泵(溢流泵)3002电流反馈 | drop | `(deleted)` | [Cat-7: 渣浆泵次要电流信号（Group C）] 尾矿泵/精矿泵保留代表性频率反馈（控制量代理），删除冗余电流；事故泵属应急设备（正常生产不运行）；无名渣浆泵（33/34/41/43）无可追溯业务含义，均删除。 |
| `FX_ZJB3004_I` | 渣浆泵(溢流泵)3004电流反馈 | drop | `(deleted)` | [Cat-7: 渣浆泵次要电流信号（Group C）] 尾矿泵/精矿泵保留代表性频率反馈（控制量代理），删除冗余电流；事故泵属应急设备（正常生产不运行）；无名渣浆泵（33/34/41/43）无可追溯业务含义，均删除。 |
| `FX_ZJB33_F` | 渣浆泵33频率反馈 | drop | `(deleted)` | [Cat-7: 渣浆泵次要电流信号（Group C）] 尾矿泵/精矿泵保留代表性频率反馈（控制量代理），删除冗余电流；事故泵属应急设备（正常生产不运行）；无名渣浆泵（33/34/41/43）无可追溯业务含义，均删除。 |
| `FX_ZJB33_I` | 渣浆泵33电流反馈 | drop | `(deleted)` | [Cat-7: 渣浆泵次要电流信号（Group C）] 尾矿泵/精矿泵保留代表性频率反馈（控制量代理），删除冗余电流；事故泵属应急设备（正常生产不运行）；无名渣浆泵（33/34/41/43）无可追溯业务含义，均删除。 |
| `FX_ZJB34_I` | 渣浆泵34电流反馈 | drop | `(deleted)` | [Cat-7: 渣浆泵次要电流信号（Group C）] 尾矿泵/精矿泵保留代表性频率反馈（控制量代理），删除冗余电流；事故泵属应急设备（正常生产不运行）；无名渣浆泵（33/34/41/43）无可追溯业务含义，均删除。 |
| `FX_ZJB41_I` | 渣浆泵41电流反馈 | drop | `(deleted)` | [Cat-7: 渣浆泵次要电流信号（Group C）] 尾矿泵/精矿泵保留代表性频率反馈（控制量代理），删除冗余电流；事故泵属应急设备（正常生产不运行）；无名渣浆泵（33/34/41/43）无可追溯业务含义，均删除。 |
...
| `MC1_AH10_AI5` | 磨磁1#配电室2#变压器总功率因素 | drop | `(deleted)` | [Cat-2: 电能计量表] 专家知识文档各段观测空间均不包含变压器/变频器电能指标（有功功率/无功功率/功率因素/电网频率）。这些量反映电力消耗，对矿产品品位无直接解释力，删除以减少 DML 模型噪声。 |
| `MC1_AH12_AI5` | 磨磁6#塔磨机总功率因素 | drop | `(deleted)` | [Cat-2: 电能计量表] 专家知识文档各段观测空间均不包含变压器/变频器电能指标（有功功率/无功功率/功率因素/电网频率）。这些量反映电力消耗，对矿产品品位无直接解释力，删除以减少 DML 模型噪声。 |
| `MC1_AH12_AI7` | 磨磁6#塔磨机总瞬时无功功率 | drop | `(deleted)` | [Cat-2: 电能计量表] 专家知识文档各段观测空间均不包含变压器/变频器电能指标（有功功率/无功功率/功率因素/电网频率）。这些量反映电力消耗，对矿产品品位无直接解释力，删除以减少 DML 模型噪声。 |
| `MC1_AH6_AI6` | 磨磁3#配电室2#变压器总瞬时有功功率 | drop | `(deleted)` | [Cat-2: 电能计量表] 专家知识文档各段观测空间均不包含变压器/变频器电能指标（有功功率/无功功率/功率因素/电网频率）。这些量反映电力消耗，对矿产品品位无直接解释力，删除以减少 DML 模型噪声。 |
| `MC1_AH8_AI5` | 磨磁2#配电室2#变压器总功率因素 | drop | `(deleted)` | [Cat-2: 电能计量表] 专家知识文档各段观测空间均不包含变压器/变频器电能指标（有功功率/无功功率/功率因素/电网频率）。这些量反映电力消耗，对矿产品品位无直接解释力，删除以减少 DML 模型噪声。 |
| `MC1_AH9_AI4` | 磨磁3#配电室1#变压器电网频率 | drop | `(deleted)` | [Cat-2: 电能计量表] 专家知识文档各段观测空间均不包含变压器/变频器电能指标（有功功率/无功功率/功率因素/电网频率）。这些量反映电力消耗，对矿产品品位无直接解释力，删除以减少 DML 模型噪声。 |
...
| `MC2_CQC_GNJNJ_AI` | 挂泥电机扭矩 | drop | `(deleted)` | [Cat-6: 浓缩机/磁选机机械监测] 提耙压力、落耙压力、挂泥电机扭矩为设备健康监测量，专家知识文档未将其列入磁选/浓缩段的观测或控制空间，对矿石品位无直接影响。 |
...
| `MC2_NSJ_LPYL_AI` | 落耙压力 | drop | `(deleted)` | [Cat-6: 浓缩机/磁选机机械监测] 提耙压力、落耙压力、挂泥电机扭矩为设备健康监测量，专家知识文档未将其列入磁选/浓缩段的观测或控制空间，对矿石品位无直接影响。 |
| `MC2_NSJ_TPYL_AI` | 提耙压力 | drop | `(deleted)` | [Cat-6: 浓缩机/磁选机机械监测] 提耙压力、落耙压力、挂泥电机扭矩为设备健康监测量，专家知识文档未将其列入磁选/浓缩段的观测或控制空间，对矿石品位无直接影响。 |
